...
<main>
  <div class="container">
    ...
    <div class="right-align">
      ...
      -->
      <a href="#modal1" class="waves-effect waves-light btn modal-trigger blue-grey darken-3 disabled" >Programar Mantenimiento<i class="material-icons right">border_color</i></a>
      <a href="#modal2" class="waves-effect waves-light btn modal-trigger blue-grey darken-3 disabled" >Realizar Mantenimiento<i class="material-icons right">border_color</i></a>
    </div>
...
<div id="modal2" class="modal">
  <?= form_open('Sistemactrl/realizarMantenimiento')?>
  <div class="modal-content">
    <h4>Realizar mantenimiento</h4>
    <input type="hidden" name="id_activo" class = "id_activo" value="" />
    <br>
    <div class="">
      <h5>Tipo de Mantenimiento</h5>
      <p>
      ...
      <p>
        <input name="mantenimiento" value="2" type="radio" id="test2" checked required/>
        <label for="test2">Correctivo</label>
      </p>
    </div>
    <br>
    <div class="input-field">
      <input type="text" class="datepicker" name="fecha_programado" id="fecha_programado" required>
      <label for="fecha_programado">Fecha programada</label>
    </div>
    <div class="input-field">
      <input type="text" class="datepicker" data-value="<?=$hoy ?>" name="fecha_realizado" id="fecha_realizado" required>
      <label for="fecha_realizado">Fecha realizada</label>
    </div>
    <br>
    <div class="input-field">
      <input type="number" step="0.01" min="0" name="costo_venta" id="costo_venta" required>
