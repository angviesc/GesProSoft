 ...
 ?>
  <ul id="slide-out" class="side-nav fixed z-depth-2">
    ...
    <ul class="collapsible" data-collapsible="accordion">
      ...
      <li id="dash_categories">
        <div id="dash_categories_header" class="collapsible-header waves-effect"><b>Sistema</b></div>
        <div id="dash_categories_body" class="collapsible-body">
          <ul>
            <li id="users_customer">
              <a class="waves-effect" style="text-decoration: none;" href="<?=site_url('Sistemactrl/cerrarSesion')?>">Cerrar Sesion</a>
            </li>
          </ul>
        </div>
      </li>
...
<header>
  <ul class="dropdown-content" id="user_dropdown">
    ...
    <li><a class="blue-grey-text" href="<?=site_url('Sistemactrl/cerrarSesion')?>">Cerrar session</a></li>
  </ul>
